...
export default function HeaderSearch(props) {
 ...
 <div className='font-medium text-black'>Địa điểm</div>
      ...
      <input placeholder='Bạn sắp đi đâu ?' type={'text'} onChange={(e)=>setSearchValue(e.target.value)} onClick={(e)=>{
    ...
    <TabPane  tab={<div className='flex flex-col  '><span className='font-semibold'>Nhận phòng</span>
    <span className="font-sans text-gray-500">Thêm ngày</span>
    </div>} key="2">
      Content of Tab Pane 2
    </TabPane>
    <TabPane tab={<div className='flex flex-col '><span className='font-semibold'>Trả phòng</span>
    <span className="font-sans text-gray-500">Thêm ngày</span>
    </div>}  key="3">
      Content of Tab Pane 3
    </TabPane>
    <TabPane tab={<div className='flex flex-col '><span className='font-semibold'>Khách</span>
